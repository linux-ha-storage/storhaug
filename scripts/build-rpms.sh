...
mkdir -p repo/el6
mkdir -p repo/el7
sudo mock -r epel-6-x86_64 --resultdir repo/el6/ SRPMS/storhaug-${VERSION}-${HEADREL}.el6.centos.src.rpm
sudo mock -r epel-7-x86_64 --resultdir repo/el7/ SRPMS/storhaug-${VERSION}-${HEADREL}.el7.centos.src.rpm
createrepo repo/el6/
createrepo repo/el7/
